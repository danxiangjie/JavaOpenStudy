package com.wenbin.framework.redis.pipleAndtranaction;
...
import com.wenbin.framework.util.Constants;

public class pipleAndtranactionDemo {
	private Jedis jedis;//

	pipleAndtranactionDemo(String host, int port) {
	...
	public void pipeline() {
		...
		try {
			...
			System.out
					.println("Error,you cant get() before sync,because IO of response hasn't begin..");
		}
	...
	public static void main(String[] args) throws Exception {
		pipleAndtranactionDemo client = new pipleAndtranactionDemo(
