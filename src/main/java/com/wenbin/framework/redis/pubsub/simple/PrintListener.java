...
public class PrintListener extends JedisPubSub {
	...
	public void onSubscribe(String channel, int subscribedChannels) {
		System.out.println("subscribe:" + channel + ";total channels : "
				+ subscribedChannels);
	...
	public void onUnsubscribe(String channel, int subscribedChannels) {
		System.out.println("unsubscribe:" + channel + ";total channels : "
				+ subscribedChannels);
	...
	public void onPMessage(String pattern, String channel, String message) {
		System.out.println("message receive:" + message + ",pattern channel:"
				+ channel);
